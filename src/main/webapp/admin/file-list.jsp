                ...
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space5" lay-filter="formTest"  >
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name"  placeholder="请输入文件名称" autocomplete="off" class="layui-input" id="name" >
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <select class="layui-form-select" name="type" ></select>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
...
<script>
    layui.use(['form','table','jquery','layer','laytpl','laydate'], function(){
        ...
        var tableIns = table.render({
            ...
            ,height: 350
            ,url: '${pageContext.request.contextPath}/adminController/findFileList' //数据接口
            ,method:'get'
            ,where: {}//查询条件
            ,request: {
            ...
            ,parseData: function(res){ //res 即为原始返回的数据
                console.log( statusParams=res.paramsList)
