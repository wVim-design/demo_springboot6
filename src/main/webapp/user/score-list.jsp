...
<script>
    layui.use(['form','table','jquery','layer','laytpl','laydate'], function(){
        ...
        var tableIns = table.render({
            ...
            ,height: 350
            ,url: '${pageContext.request.contextPath}/userController/findScoreList' //数据接口
            ,method:'get'
            ,where: {}//查询条件
            ,request: {
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'type', title: '明细类型', width:180, sort: true}
                ,{field: 'score', title: '分数', width:100, sort: true}
                ,{field: 'fileName', title: '文件名', width:160, sort: true}
                ,{field: 'createTime', title: '时间', width:120, sort: true}
            ]]
        });
